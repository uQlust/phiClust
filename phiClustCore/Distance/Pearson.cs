...
namespace phiClustCore.Distance
{
    ...
    {
        public Pearson(string dirName, string alignFile, bool flag, string profileName,Options opt):
                base(dirName,alignFile,flag,profileName,opt)
        {

        }
        public Pearson(List<string> fileNames, string alignFile, bool flag, string profileName, Options opt,string refJuryProfile = null) 
            :base(fileNames, alignFile, flag,  profileName,opt,refJuryProfile)
        {

        }
        public Pearson(string dirName,string alignFile,bool flag,string profileName,Options opt,string refJuryProfile=null) 
            :base(dirName,alignFile,flag,profileName,opt,refJuryProfile) 
        {
          
        }
        public Pearson(string profilesFile, bool flag, string profileName, string refJuryProfile,Options opt)
